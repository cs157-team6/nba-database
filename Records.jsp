		...
		<section class="portfolio-block projects-cards">
			<div class="container">
				...
				try {
					...
					ResultSet rs = stmt.executeQuery("select record.record_id, record.description, record.value, player.name, record.team_name, record.match_id from record, player where record.player_number = player.number and   record.Team_Name = player.Team_Name;");

					out.println("<table><tr><th>ID</th><th>Description</th><th>Value</th><th>Player Name</th><th>Team Name</th><th>Match ID</th></tr>");
					while (rs.next()) {
