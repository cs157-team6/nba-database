			...
			<div class="container">
				<div class="heading">
					<img style="min-width: 300px; height: 200px;"
						src="https://i.imgur.com/BqrD9Jy.png">
				</div>
				<%
				...
				try {
					...
					ResultSet rs = stmt.executeQuery("SELECT * FROM `cs157a-team6`.player WHERE Team_Name = 'Portland Trail Blazers' ORDER BY Number ASC");
