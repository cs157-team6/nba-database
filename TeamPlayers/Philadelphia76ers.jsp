			...
			<div class="container">
				<div class="heading">
					<img style="min-width: 300px; height: 200px;"
						src="https://i.imgur.com/cPI7jof.png">
				</div>
				<%
				...
				try {
					...
					ResultSet rs = stmt.executeQuery("SELECT * FROM `cs157a-team6`.player WHERE Team_Name = 'Philadelphia 76ers' ORDER BY Number ASC");
