			...
			<div class="container">
				<div class="heading">
					<img style="min-width: 300px; height: 200px;"
						src="https://i.imgur.com/UW940hJ.png">
				</div>
				<%
				...
				try {
					...
					ResultSet rs = stmt.executeQuery("SELECT * FROM `cs157a-team6`.player WHERE Team_Name = 'Golden State Warriors' ORDER BY Number ASC");
