...
<body>
    <nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-white portfolio-navbar gradient">
        <div class="container"><a class="navbar-brand logo" href="#">NBA Database</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navbarNav-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
				...
				<% 
								 ...
								 String password = "6eP5hy!Vy@@QstA3o8mwRdnK";
									try {
										...
										while (rs.next()) {
											out.println("<tr><td>" + rs.getString(3) + "</td><td>" + rs.getString(1) + "</td><td>" + rs.getString(4) + "</td></tr>");
										}
										out.println("</table>");
										rs.close();
										stmt.close();
